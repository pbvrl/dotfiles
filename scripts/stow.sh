...
cd "$HOME/.config/nixos/scripts_as_dotfiles/opencode" || exit  
stow --restow plugin       -t "$HOME/.config/opencode/plugin"
...
stow --restow fnott         -t "$HOME/.config/fnott"
...
stow --restow wluma         -t "$HOME/.config/wluma"
