{
  ...
  config.nixpkgs.config.allowUnfreePredicate = pkg:
    builtins.elem (lib.getName pkg) config.userDefinedGlobalVariables.allowedUnfreePackages;
  config.userDefinedGlobalVariables.allowedUnfreePackages = [
    "claude-code"
  ];
  ...
  config.environment.systemPackages = with pkgs; [
    ...
    upower
    # Notifications
    # fnott itself is installed by ../dotfiles/fnott.nix, which patches it.
    libnotify
